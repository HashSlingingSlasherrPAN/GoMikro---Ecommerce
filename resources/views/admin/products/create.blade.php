...
<div class="w-full overflow-x-auto bg-[#fbfbfb] rounded-lg shadow-md p-6">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-wrap">
        ...
        <div class="flex-1 pl-4">
            ...
            <div>
                ...
                <div class="flex justify-center mt-4 pb-5">
                    <img id="imagePreview" class="w-full max-w-xs rounded-md shadow-md focus:border-[#02b18a] active:border-[#02b18a] focus:outline-none" alt="Pratinjau Gambar" style="display: none;">
                </div>
