                    ...
                    <div class="py-[40px] text-[1rem] font-[400]  grid gap-[12px]   px-[40px] rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)] my-[100px]">
                        ...
                        <form class="grid gap-[8px]" action="{{ route('login') }}" method="POST">
                            ...
                            <div>
                                ...
                                <input class="border  border-gray-300   focus:outline-none focus:ring-[1px]  focus:ring-[#02B18A]  my-[4px] rounded-md w-full bg-gray-50 py-[8px] px-[8px] " required type="text" name="email" value="{{ old('email') }}" id="email" placeholder="Masukan email">
                                  @if($errors->has('email'))
                                  <p class="text-red-600 text-[0.875rem] mt-[4px]">{{ $errors->first('email') }}</p>
                                   @endif
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-red-600 text-[0.875rem] mt-[4px]">{{ $errors->first('password') }}</p>
                               @endif
                            </div>
